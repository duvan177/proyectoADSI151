            ...
            <div class="container-fluid">
              ...
              <tr v-for="PerfilesAlarmas in arrayEstado" :key="PerfilesAlarmas.id">
                ...
                <!--<td v-text="PerfilesAlarmas.idUsuario"></td>-->
                 ...
                 <!--<td>
                  <div v-if="PerfilesAlarmas.nombre == 'Nuevo'">
                    <span class="badge badge-success">NUevo</span>
                  </div>
                  <div v-else-if="PerfilesAlarmas.nombre == 'Traer'">
                    <span class="badge badge-success">Traer</span>
                  </div>
                 <div v-else-if="PerfilesAlarmas.nombre== 'Apagado'">
                    <span class="badge badge-danger">Apagado</span>
                  </div>
                  <div v-else-if="PerfilesAlarmas.nombre == 'Cerrada'">
